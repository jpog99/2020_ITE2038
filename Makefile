...
SRCS_FOR_LIB:=$(SRCDIR)bpt.cpp $(SRCDIR)buffer_manager.cpp $(SRCDIR)dbapi.cpp $(SRCDIR)file.cpp $(SRCDIR)main.cpp $(SRCDIR)lock_manager.cpp
...
$(SRCDIR)dbapi.o:
	$(CC) $(CFLAGS) -o $(SRCDIR)dbapi.o -c $(SRCDIR)dbapi.cpp

$(SRCDIR)file.o:
	$(CC) $(CFLAGS) -o $(SRCDIR)file.o -c $(SRCDIR)file.cpp
